/*
  ...
  1. Changes
    - Update cost_price and selling_price for all data plans
    - Recalculate profit_margin based on new prices
    - Mark popular plans for better visibility
    - Add discount badges to selected plans

  2. Purpose
    - Align pricing with current API user pricing
    - Ensure competitive pricing in the market
    - Highlight popular plans for better user experience
*/
...
WHERE network = 'AIRTEL' AND size = '1.0 GB' AND validity = '3 Days';

UPDATE data_plans
SET cost_price = 355, selling_price = 380
WHERE network = 'AIRTEL' AND size = '1.0 GB' AND validity = '1 Day';

UPDATE data_plans
SET cost_price = 410, selling_price = 440
WHERE network = 'AIRTEL' AND size = '1.5 GB' AND validity = '1 Day';
...
WHERE network = 'AIRTEL' AND size = '2.0 GB' AND validity = '2 Days';

UPDATE data_plans
SET cost_price = 819, selling_price = 870
WHERE network = 'AIRTEL' AND size = '4.0 GB' AND validity = '2 Days';
...
WHERE network = 'AIRTEL' AND size = '7.0 GB' AND validity = '7 Days';

UPDATE data_plans
SET cost_price = 3080, selling_price = 3200
WHERE network = 'AIRTEL' AND size = '10.0 GB' AND validity = '30 Days';
...
WHERE network = 'AIRTEL' AND size = '13.0 GB' AND validity = '30 Days';
...
WHERE network = 'AIRTEL' AND size = '35.0 GB' AND validity = '30 Days';
...
WHERE network = 'AIRTEL' AND size = '60.0 GB' AND validity = '30 Days';
...
WHERE network = 'AIRTEL' AND size = '100.0 GB' AND validity = '30 Days';
