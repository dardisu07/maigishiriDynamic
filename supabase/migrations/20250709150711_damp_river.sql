/*
  # Update data plan prices with new API pricing
  ...
  2. Purpose
    - Ensure data plans have accurate and competitive pricing
    - Improve user experience with clear popular plan indicators
    - Highlight discounted plans with badges
*/
...
WHERE network = 'AIRTEL' AND size = '1.0 GB' AND validity LIKE '3 Days%';
...
WHERE network = 'AIRTEL' AND size = '2.0 GB' AND validity LIKE '2 Days%';

UPDATE data_plans
SET cost_price = 819, selling_price = 870
WHERE network = 'AIRTEL' AND size = '4.0 GB' AND validity LIKE '2 Days%';
...
WHERE network = 'AIRTEL' AND size = '7.0 GB' AND validity LIKE '7 Days%';

UPDATE data_plans
SET cost_price = 3080, selling_price = 3200
WHERE network = 'AIRTEL' AND size = '10.0 GB' AND validity LIKE '30 Days%';
...
WHERE network = 'AIRTEL' AND size = '13.0 GB' AND validity LIKE '30 Days%';
...
WHERE network = 'AIRTEL' AND size = '35.0 GB' AND validity LIKE '30 Days%';
...
WHERE network = 'AIRTEL' AND size = '60.0 GB' AND validity LIKE '30 Days%';
...
WHERE network = 'AIRTEL' AND size = '100.0 GB' AND validity LIKE '30 Days%';
